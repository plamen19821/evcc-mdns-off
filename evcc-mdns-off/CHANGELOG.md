...
* Add SENEC.Connect cloud API (#33029)
...
* Energy Price Forecast: add api key (#33081)
...
* Solax X1/X3-HAC: add CurrentLimiter (#33181)
...
* Youless: add return energy (#33155)
...
* Config UI: hide disabled vehicles from loadpoint default-vehicle dropdown (#33125)
* DaheimLaden: improve error handling (#33010)
* Demo tariffs: increase forecast to 5 days (#33174)
...
* Enovates: verify EMS mode and use actually offered current (#33163)
* Go plugin: keep float parameters typed (#33162)
* GoodWe: list ESA series under hybrid template (#32884)
* Grünstromindex: fall back to co2_g_oekostrom when co2_g_standard is null (#33164)
* History: keep charge and discharge apart in entity legend sums (#33299)
* History: show both directions for all entities of a bidirectional section (#33335)
...
* Keep permanent sentinel errors distinguishable (#33194)
...
* Nissan: switch to MyNISSAN OneID authentication (#33316)
...
* Sungrow: remove coarse energy reading from inverter template (#33321)
...
* Vehicle settings: compact rows layout (#33169)
...
* Zaptec Go 2: disable phase switching with APM active (#33255)
* [BUGFIX] Update url / backup example curl command  (#32984)
* api: let Identify return multiple identities (#32949)
* fox-ess-h3-smart: remove limitsoc so batterymode is applied (#33325)
...
* pvnode: revert to end-labelled interval resampling (#33133)
...
* UI: fix blurred energy flow bar labels in Safari (#33144)
...
No functional changes- re-release of 0.314.0 for technical reasons.
...
* Meter (FoxESS H3-Pro/Smart): add battery control (#32301)
...
* UI: allow vehicle charging limit below 20%, include api-set values (#32460)
* UI: apply 5% floor to vehicle limit slider (#32462)
...
* Vaillant: share token source across chargers on the same account (#32471)
...
* Atmoce: fix curtailed for battery (#32453)
...
* Add SolvisControl 2/3 heatpump (#31976)
...
* Home Assistant: add features config (heating/integrateddevice) (#32288)
* Huawei SUN2000: add curtailment description (#32188)
* PowerOpti: add grid energy (#32281)
...
* EEBus: update eebus-go/ship-go, drop eebus-go replace (#31980)
...
* Mercedes: remove broken odo, maxSoc and status (#32293)
...
* Remove deprecated Smart EQ (#32294)
...
* Shelly: fix PM1 Gen3 energy readings (#31957)
...
* Marstek Venus: add holdcharge battery mode (#31831)
* Phoenix EV-ETH: add millicurrentsupported option (#31860)
...
* Config: show vehicle asleep state instead of value errors (#31859)
...
### Bug Fixes 🐞
* Anker-solix-x1: fix energy scale (0.01 kWh/LSB) and revert PV changes (#31787)
